...
void handleRoot() 
{
  ...
  server.send(200, "text/plain", "http://www.esqsoft.com/examples/troubleshooting-http-using-telnet.htm");
}
...
{ const char* host;
  ...
  while(client.available())
  {
    ...
    line.replace("Telnet", "WOW-THAT-WORKS");
    line.replace("telnet", "WOW-THAT-WORKS");
  }
